...
const Contact = () => {
  return (
    <div id="contact" className="w-full px-3 pt-4 md:pt-9 pb-56">
      <div className="max-w-[1000px] m-auto ">
        <div className="md:flex gap-8 md:max-w-[80%] m-auto ">
          <div
            data-aos="zoom-in"
            data-aos-offset="-200"
            className="w-full h-auto shadow-2xl rounded-xl p-4 lg:p-10"
          >
            <form action="https://formspree.io/f/xyyqalzl" method="POST">
              ...
              <div className="flex flex-col py-2 text-black mb-4">
                <Textarea
                  label="Descripción"
