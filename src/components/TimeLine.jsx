      ...
      <ol className="ml-1   md:ml-[30%] border-s border-gray-200 dark:border-gray-700">
        <li class="mb-10 ms-4 w-80 md:w-[50%]">
          ...
          <p class="mb-4  text-[15px] md:text-base font-normal text-gray-500 dark:text-gray-400 ">
            Desarrollo de plataforma web donde el foco principal es la gestión,
            adquisición y control de inventario, simplificando el onboarding y
            equipamiento para trabajadores remotos. <br />
            <strong>
        ...
        <li class="mb-10 ms-4 w-80 md:w-[50%]">
          ...
          <p class="mb-4 text-[15px] md:text-base font-normal text-gray-500 dark:text-gray-400">
            ...
            real. Posee perfiles de usuario, administrador y repartidor. <br />
            <strong>
              Equipo de 4 desarrolladores, metodología ágil, sprints semanales.
            </strong>
          </p>
        </li>
        ...
        <li class="mb-10 w-80 ms-4 md:w-[50%]">
          ...
          <p class="text-[15px] md:text-base font-normal text-gray-500 dark:text-gray-400">
            Como Founder de este proyecto, lideré la creación y desarrollo de
            un innovador mercado de bebidas/vinoteca. Mi visión y dedicación han
            sido pilares fundamentales para establecer este espacio como una
            opción distintiva en la zona. 
          </p>
          <a
        ...
        <li class="ms-4 w-80 md:w-[50%]">
          ...
          <p class="text-[15px] md:text-base font-normal text-gray-500 dark:text-gray-400">
            Como Co-Founder de Bohemia Cervecería, lideré el desarrollo integral
            del negocio desde su concepción hasta su implementación,
            desempeñando un papel fundamental en todas las etapas del
            establecimiento. Mi enfoque estratégico y ejecución hábil fueron
            esenciales para llevar a la realidad la visión de Bohemia
            Cervecería, consolidándola con éxito como un referente en la escena
        ...
        <li class="mt-10 ms-4 w-80 md:w-[50%]">
          ...
          <p class="text-[15px] md:text-base font-normal text-gray-500 dark:text-gray-400">
            Como diseñador, tuve la oportunidad de trabajar en una variedad de
            proyectos creativos que incluyen la creación de piezas
            publicitarias, contenido para redes sociales, producción
            fotográfica, edición de foto y video, además brindar aportes
            creativos y asesoramiento a los clientes. En mi camino cooperé en el
            rebranding de varias marcas de indumentaria, fusionando mi interes
            por el diseño gráfico con la moda para impulsar el éxito de mis
            clientes. Mi enfoque se centró en la innovación y la comunicación
            efectiva a través del diseño, siempre buscando superar las
            expectativas y lograr resultados impactantes.
          </p>
          <a
